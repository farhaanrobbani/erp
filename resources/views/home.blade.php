...
@section('content')
    ...
    {{-- Hero --}}
    <section class="relative overflow-hidden bg-slate-950 pt-32 pb-20 text-white">
        <div class="absolute inset-0 opacity-30"
             style="background-image: radial-gradient(circle at 20% 30%, #f59e0b33, transparent 45%), radial-gradient(circle at 80% 70%, #0ea5e933, transparent 40%);">
        </div>
        <div class="relative mx-auto max-w-7xl px-6">
            <p class="mb-4 inline-flex items-center gap-2 rounded-full border border-amber-500/40 bg-amber-500/10 px-4 py-1 text-xs font-semibold text-amber-400">
                Terdaftar &amp; terverifikasi untuk pengadaan BUMN/LPSE
            </p>
            <h1 class="max-w-3xl text-4xl font-extrabold leading-tight md:text-6xl">
                Membangun Infrastruktur,<br>Menghadirkan <span class="text-amber-400">Kepercayaan.</span>
            </h1>
            ...
            <div class="mt-8 flex flex-wrap gap-4">
                <a href="#kontak" class="rounded-lg bg-amber-500 px-6 py-3 text-sm font-semibold text-white hover:bg-amber-600">Diskusikan Proyek</a>
            ...
            <div class="mt-14 grid grid-cols-2 gap-6 border-t border-white/10 pt-8 md:grid-cols-4">
                <div><p class="text-3xl font-extrabold text-amber-400">150+</p><p class="mt-1 text-sm text-slate-400">Proyek Selesai</p></div>
                <div><p class="text-3xl font-extrabold text-amber-400">30+</p><p class="mt-1 text-sm text-slate-400">Klien BUMN</p></div>
                <div><p class="text-3xl font-extrabold text-amber-400">5.000.000+</p><p class="mt-1 text-sm text-slate-400">Jam Kerja Selamat</p></div>
                <div><p class="text-3xl font-extrabold text-amber-400">ISO</p><p class="mt-1 text-sm text-slate-400">9001 / 14001 / 45001</p></div>
            </div>
        </div>
    </section>
    ...
    <section id="tentang" class="py-20">
        <div class="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 md:grid-cols-2">
            <div>
                <p class="text-sm font-semibold text-amber-600">TENTANG KAMI</p>
                ...
                <ul class="mt-6 space-y-3 text-slate-700">
                    <li class="flex gap-3"><span class="text-amber-500">✔</span> SBU Kualifikasi Besar — Bidang Bangunan Gedung &amp; Sipil</li>
                    <li class="flex gap-3"><span class="text-amber-500">✔</span> Terdaftar di LPSE &amp; e-Catalogue Kementerian PUPR</li>
                    <li class="flex gap-3"><span class="text-amber-500">✔</span> Tenaga ahli bersertifikat SKK/SKA</li>
                    <li class="flex gap-3"><span class="text-amber-500">✔</span> Sistem Manajemen K3 teraudit</li>
                </ul>
            </div>
    ...
    <section id="layanan" class="bg-slate-50 py-20">
        <div class="mx-auto max-w-7xl px-6">
            <p class="text-sm font-semibold text-amber-600">BIDANG USAHA</p>
            ...
            <div class="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
                @foreach ([
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md">
                        <div class="h-10 w-10 rounded-lg bg-amber-500/15 text-center text-xl">🏗️</div>
    ...
    <section id="portofolio" class="py-20">
        <div class="mx-auto max-w-7xl px-6">
            <div class="flex items-end justify-between">
                <div>
                    <p class="text-sm font-semibold text-amber-600">PORTOFOLIO</p>
    ...
    {{-- HSE / K3 --}}
    <section id="k3" class="bg-slate-950 py-20 text-white">
        <div class="mx-auto max-w-7xl px-6">
            <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    <p class="text-sm font-semibold text-amber-400">HSE / K3</p>
                    ...
                    <div class="mt-6 grid grid-cols-2 gap-4">
                        <div class="rounded-xl border border-white/10 p-4">
                            <p class="text-2xl font-extrabold text-amber-400">0</p>
                            <p class="text-sm text-slate-400">Kecelakaan Fatal</p>
                        </div>
                        <div class="rounded-xl border border-white/10 p-4">
                            <p class="text-2xl font-extrabold text-amber-400">5JT+</p>
    ...
    <section id="kontak" class="py-20">
        <div class="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 md:grid-cols-2">
            <div>
                <p class="text-sm font-semibold text-amber-600">HUBUNGI KAMI</p>
            ...
            <form action="/kontak" method="POST" class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <input name="name" type="text" placeholder="Nama" required class="rounded-lg border border-slate-300 px-4 py-2.5 text-sm focus:border-amber-500 focus:outline-none">
                    <input name="email" type="email" placeholder="Email" required class="rounded-lg border border-slate-300 px-4 py-2.5 text-sm focus:border-amber-500 focus:outline-none">
                </div>
                <input name="phone" type="tel" placeholder="No. HP" class="mt-4 w-full rounded-lg border border-slate-300 px-4 py-2.5 text-sm focus:border-amber-500 focus:outline-none">
                <input name="subject" type="text" placeholder="Perihal" required class="mt-4 w-full rounded-lg border border-slate-300 px-4 py-2.5 text-sm focus:border-amber-500 focus:outline-none">
                <textarea name="message" placeholder="Pesan" required rows="4" class="mt-4 w-full rounded-lg border border-slate-300 px-4 py-2.5 text-sm focus:border-amber-500 focus:outline-none"></textarea>
                <button type="submit" class="mt-5 w-full rounded-lg bg-amber-500 px-6 py-3 text-sm font-semibold text-white hover:bg-amber-600">Kirim Pesan</button>
            </form>
        </div>
    </section>
@endsection
